...
class Cookiestand {
    constructor(location, hours, salesPerHour1000, salesPerHour1100, salesPerHour1200, salesPerHour1300, salesPerHour1400, salesPerHour1500, salesPerHour1600, salesPerHour1700, salesPerHour1800)
    {
        ...
        this.dailySales = function(){
            return this.salesPerHour1000 + this.salesPerHour1100 + this.salesPerHour1200 + this.salesPerHour1300 + this.salesPerHour1400 + this.salesPerHour1500 + this.salesPerHour1600 + this.salesPerHour1700 + this.salesPerHour1800;
        };
    }
}
